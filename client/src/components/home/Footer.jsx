...
const Footer = () => {
    return (
        <div className="bg-gradient-to-r from-white via-green-200/60 to-white">
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
