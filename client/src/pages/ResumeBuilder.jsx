...
import { ArrowLeft, ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share, Share2Icon, Sparkles, User } from 'lucide-react'
                ...
                <div className='grid lg:grid-cols-12 gap-8'>
                            ...
                            <div className='space-y-6'>
                                {activeSection.id === 'personal' && (
                                    <PersonalInfoForm data={resumeData.personal_info} onchange
                                        ={(data) => setResumeData(prev => ({ ...prev, personal_info: data }))} removeBackground={removeBackground} setRemoveBackground={setRemoveBackground} />
                                )}
                    ...
                    <div className="lg:col-span-7 max-lg:mt-6">
                        ...
                        <div className="flex justify-end items-center gap-2 mb-4">
                            {resumeData.public && (
                                <button onClick={handleShare} className="flex items-center gap-2 px-4 py-2 text-xs bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-lg hover:ring ring-blue-300">
                                    <Share2Icon className="size-4" />Share
                                </button>
                            )}

                            <button onClick={changeResumeVisiblity} className="flex items-center gap-2 px-4 py-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 rounded-lg hover:ring ring-purple-300">
                                {resumeData.public
                            ...
                            <button onClick={downloadResume} className="flex items-center gap-2 px-4 py-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 rounded-lg hover:ring ring-green-300">
